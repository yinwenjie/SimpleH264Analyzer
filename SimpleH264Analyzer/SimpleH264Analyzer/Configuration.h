...
#define TRACE_CONFIG_BLOCK_REF_PIX 0
#define TRACE_CONFIG_BLOCK_PRED_BLOCK 0
#define TRACE_CONFIG_BLOCK_RECON_BLOCK 0
#define TRACE_CONFIG_BLOCK_COEF_BLK_LUMA 1
